...
from .glt_v3 import GroupLinearV3

class SHgruV12(nn.Module):
    def __init__(
        self,
        embed_dim,
        gate_dim=128,
        ...
        self.in_proj = GroupLinearV3(embed_dim // expand_ratio, embed_dim * 3, expand_ratio)
        self.out_proj = GroupLinearV3(
