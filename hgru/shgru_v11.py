...
from .glt_post import GroupLinearPost

class SHgruV11(nn.Module):
    def __init__(
        self,
        embed_dim,
        gate_dim=128,
        ...
        self.in_proj = GroupLinearPost(embed_dim // expand_ratio, embed_dim * 3, expand_ratio)
        self.out_proj = GroupLinearPost(
