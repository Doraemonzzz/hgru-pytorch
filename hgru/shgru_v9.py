...
class SHgruV9(nn.Module):
    def __init__(
        ...
        proj_weight = torch.empty(embed_dim // expand_ratio, 3 * expand_ratio * embed_dim).uniform_(-c1, c1)
    ...
    def forward(self, x, lower_bound=0):
        ...
        feature = torch.einsum('n b k d, d e -> n b e', x, self.proj_weight)
